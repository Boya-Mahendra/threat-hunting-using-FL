"""block_hunter URL Configuration
...
from block_hunter import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Cyber_Threat_Type/$', remoteuser.Predict_Cyber_Threat_Type, name="Predict_Cyber_Threat_Type"),
    ...
    url(r'^View_Cyber_Threat_Type_Ratio/$', serviceprovider.View_Cyber_Threat_Type_Ratio, name="View_Cyber_Threat_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Cyber_Threat_Type/$',serviceprovider.View_Prediction_Of_Cyber_Threat_Type, name="View_Prediction_Of_Cyber_Threat_Type"),
